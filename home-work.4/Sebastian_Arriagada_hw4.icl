module Sebastian_Arriagada_hw4
import StdEnv
...
| factor1 && factor2  && factor3 = [tuple]
= []
where 
	factor1 = ( isMember (fst3 tuple) array  )
	factor2 = ( isMember (snd3 tuple) array  )
	factor3 = ( isMember (thd3 tuple) array  )
